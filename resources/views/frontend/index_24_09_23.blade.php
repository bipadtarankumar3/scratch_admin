...
<body class="front_background "  oncontextmenu="return false">
          ...
          <form class="my-4 p-4" action="{{URL::to('u/spinner_form/post')}}" method="POST" id="spinner_form" enctype="multipart/form-data">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="number" name="whatsapp_number" class="form-control" id="whatsapp_number" placeholder="whatsapp Number" required>
              </div>
              @endif
            ...
            <div class="form-row">
              ...
              @if (count($BikeModel) > 0)
                  <div class="form-group col-md-6">
                    <label for="screenshot">Are You Intrested in</label>
              ...
              <div class="form-group col-md-6">
                ...
                <input type="file" name="screenshot" class="form-control" id="screenshot" placeholder="Screenshot">
              </div>
              @endif
